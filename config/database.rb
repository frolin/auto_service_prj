...
ActiveRecord::Base.configurations[:development] = {
  ...
  ActiveRecord::Base.configurations[:production] = {
      ...
      :password => 'NdsnOZuRN0voWEygfwObrXi4Nd',
...
# ActiveRecord::Base.configurations[:development] = {
#   :adapter => 'sqlite3',
#   :database => Padrino.root('db', 'sass_prj_development.db')
#
# }
#
# ActiveRecord::Base.configurations[:production] = {
#   :adapter => 'sqlite3',
#   :database => Padrino.root('db', 'sass_prj_production.db')
#
# }
#
# ActiveRecord::Base.configurations[:test] = {
#   :adapter => 'sqlite3',
#   :database => Padrino.root('db', 'sass_prj_test.db')
#
# }
